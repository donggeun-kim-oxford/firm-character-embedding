...
EMB_PATH         = "output_all/row_to_emb.npy"
RET_JSON         = "output_all/row_to_ret.json"
COMPANY_JSON     = "output_all/row_to_company.json"
DATE_JSON        = "output_all/row_to_date.json"
TRAIN_FILES_JSON = "train_files.json"
TEST_FILES_JSON  = "test_files.json"
PERF_JSON        =  "perf_history_saint.json"


OUTPUT_BASE = "analysis_output/embed_analysis"
NEIGHBOR_OUTPUT_DIR       = os.path.join(OUTPUT_BASE, "neighbor_analysis")
SIGN_OUTPUT_DIR =  os.path.join(OUTPUT_BASE, "sign_accuracy")
SIGN_TIME_OUTPUT_DIR =  os.path.join(OUTPUT_BASE, "sign_accuracy_timeseries")
MEAN_TIME_DIFF_OUTPUT_DIR = os.path.join(OUTPUT_BASE, "mean_time_diff")
TRAIN_LOSS_OUTPUT_DIR = os.path.join(OUTPUT_BASE, "train_loss")

RAW_DATA_PATTERN = "../data/retrieved_data_batch_*.csv"
